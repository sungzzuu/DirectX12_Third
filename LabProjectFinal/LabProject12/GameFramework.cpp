...
bool CGameFramework::OnCreate(HINSTANCE hInstance, HWND hMainWnd)
{
	...
	// CreateRtvAndDsvDescriptorHeaps 먼저 호출해야한다. 여기서 채워넣은 값을 아래 함수들에서 사용하기 때문에
...
void CGameFramework::CreateCommandQueueAndList()
{
	...
	hResult = m_pd3dDevice->CreateCommandList(0, D3D12_COMMAND_LIST_TYPE_DIRECT, m_pd3dCommandAllocator,
...
void CGameFramework::FrameAdvance()
{
	...
	m_pd3dCommandList->ClearDepthStencilView(d3dDsvCPUDescriptorHandle,
		D3D12_CLEAR_FLAG_DEPTH | D3D12_CLEAR_FLAG_STENCIL, 1.0f, 0, 0, NULL); m_pd3dCommandList->OMSetRenderTargets(1, &d3dRtvCPUDescriptorHandle, TRUE,
